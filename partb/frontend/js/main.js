...
var devBtn = document.getElementById('settings-developer-btn');
var devSec = document.getElementById('developer-section');
if (devBtn && devSec) {
  devBtn.addEventListener('click', function() {
    devSec.style.display = devSec.style.display === 'none' ? 'block' : 'none';
  });
}
